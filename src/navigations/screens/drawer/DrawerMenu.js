  ...
  render() {
    return (
      ...
      >
        ...
        />
        <Text style={{marginTop:10,color:'black',fontSize:18,marginBottom:10}}>Nhân viên Alobo</Text>
        <TouchableOpacity onPress={()=>{
          Actions.push('Upload1')
        }}>
        <View style={{backgroundColor:'#795548',elevation:10,height:40,justifyContent:'center',width:width*0.80,alignItems:'center'}}>
          <Text style={{color:'white',fontWeight:'bold',fontSize:14,fontFamily:'Myriad-Pro'}}>Đăng thêm thông tin</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>{
          Actions.push('Check1')
        ...
        <View style={{backgroundColor:'#795548',elevation:10,height:40,justifyContent:'center',width:width*0.80,alignItems:'center',marginTop:10}}>
          <Text style={{color:'white',fontWeight:'bold',fontSize:14,fontFamily:'Myriad-Pro'}}>Thông tin đã đăng</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>{
